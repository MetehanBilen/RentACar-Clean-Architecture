...
namespace Persistence.EntityConfigurations
{
    public class ModelConfiguration : IEntityTypeConfiguration<Model>
    {
        public void Configure(EntityTypeBuilder<Model> builder)
        {
            ...
            builder.Property(m => m.TransmissonId).HasColumnName("TransmissonId").IsRequired();
            ...
            builder.HasOne(m => m.Fuel).WithMany(fm => fm.Models).HasForeignKey(m => m.FuelId);
            
            builder.HasOne(m => m.Transmisson);
